                ...
                <div class="col-md-8">
                    <div class="card border-primary bg-secondary shadow">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <div class="accordion" id="accordionExample">
                                <?php foreach ($methods as $key => $payments) : ?>
                                    <div class="accordion-item border-primary mb-2 border rounded-3 overflow-hidden">
                                        <h2 class="accordion-header border-primary">
                                        ...
                                        <div id="<?= str_replace(' ', '', $key) ?>" class="accordion-collapse collapse bg-light  border-primary" data-bs-parent="#accordionExample">
                                            <div class="accordion-body bg-secondary">
                                                ...
                                                foreach ($payments as $payment) : ?>
                                                    <div class="row g-3 align-items-center mb-2">
                                                        <div class="col-auto">
                                                            <input class="form-check-input border-primary" type="radio" name="metodePembayaran" id="<?= $payment->code ?>" value="<?= $payment->code ?>">
                                                        </div>
                                                        <div style="cursor: pointer;" onclick="$('#<?= $payment->code ?>').click()" class="col-auto">
                                                            <div class="bg-white rounded" style="height: 45px;width: 45px;background-image: url('<?= $payment->icon_url ?>');background-size: contain ;background-repeat: no-repeat; background-position: center">
                                                            </div>
                                                        </div>
                                                        <div style="cursor: pointer;" onclick="$('#<?= $payment->code ?>').click()" class="col-9">
                                                            <div>
                                                                <div class="fw-bold">
                                                                    <?= $payment->code ?>
                                                                </div>
